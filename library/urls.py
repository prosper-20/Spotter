...
from .views import BookAPIView, SingleBookAPIView,  FavoriteBooksAPIView, AuthorAPIView, SingleAuthorAPIView,AddToFvouriteAPIView, RemoveFavouriteBookView, SuggestedBooksView, RecommenderAPIView
...
urlpatterns = [
    ...
    path("books/favourites/",  FavoriteBooksAPIView.as_view(), name="favourite-books"),
